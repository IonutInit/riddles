...
const Start = ({handleStart, isLoading, available}) => {
  ...
  // const getAvailableRiddles = () => {
  //   async function availableRiddles() {
  //     const response = await fetch ('https://the-path-of-riddles.onrender.com/api/v1/riddles/random')
  //     const data = await response.json()
  //     console.log(data)
  //   }
  //   availableRiddles()
